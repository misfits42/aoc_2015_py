...
class SolutionsTestMethods(unittest.TestCase):
    ...
    def test_day_22_p1(self):
        ...
        solution = solutions.day_22.solve_part1(input)
    ...
    def test_day_24_p1(self):
        input = solutions.day_24.process_input_file()
        solution = solutions.day_24.solve_part1(input)
        self.assertEqual(11846773891, solution)

    def test_day_24_p2(self):
        input = solutions.day_24.process_input_file()
        solution = solutions.day_24.solve_part2(input)
        self.assertEqual(80393059, solution)
    
    def test_day_25_p1(self):
        input = solutions.day_25.process_input_file()
        solution = solutions.day_25.solve_part1(input)
